/*!
 * \file KW_Skin_Detection_TSL_Movie.cpp
...
#include "KW_Skin_Detection_TSL_Movie.hpp"
#include "Logger.hpp"
...
KW_Skin_Detection_TSL_Movie::KW_Skin_Detection_TSL_Movie(const std::string & name) : Base::Component(name),

	MIN_T("grupa1|  MIN_T", 5, "range"),
	MAX_T("grupa1|  MAX_T", 44, "range"),

	MIN_S("grupa2|  MIN_S", 9, "range"),
	MAX_S("grupa2|  MAX_S", 78, "range"),

	MIN_L("grupa3|  MIN_L", 124, "range"),
	MAX_L("grupa3|  MAX_L", 201, "range")

{
	LOG(LTRACE) << "Hello KW_Skin_Detection_TSL_Movie\n";
...
KW_Skin_Detection_TSL_Movie::~KW_Skin_Detection_TSL_Movie()
{
	LOG(LTRACE) << "Good bye KW_Skin_Detection_TSL2\n";
}

bool KW_Skin_Detection_TSL_Movie::onInit()
{
	LOG(LTRACE) << "KW_Skin_Detection_TSL_Movie::initialize\n";

	h_onNewImage.setup(this, &KW_Skin_Detection_TSL_Movie::onNewImage);
...
bool KW_Skin_Detection_TSL_Movie::onFinish()
{
	LOG(LTRACE) << "KW_Skin_Detection_TSL_Movie::finish\n";

	return true;
}

bool KW_Skin_Detection_TSL_Movie::onStep()
{
	LOG(LTRACE) << "KW_Skin_Detection_TSL_Movie::step\n";
	return true;
}

bool KW_Skin_Detection_TSL_Movie::onStop()
{
	return true;
}

bool KW_Skin_Detection_TSL_Movie::onStart()
{
	return true;
}

void KW_Skin_Detection_TSL_Movie::onNewImage()
{
	LOG(LTRACE) << "KW_Skin_Detection_TSL_Movie::onNewImage\n";
	try {
		...
		LOG(LERROR) << "KW_Skin_Detection_TSL_Movie::onNewImage failed\n";
	}
}
